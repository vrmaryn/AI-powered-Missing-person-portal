...
def get_train_data(submitted_by: str):
    ...
    try:
        ...
        # Log to file instead of console to avoid Windows handle errors
        error_msg = traceback.format_exc()
        logging.error(f"Error in get_train_data: {error_msg}")
        raise e
...
def train(submitted_by: str):
    ...
    try:
        ...
        # Log to file instead of console to avoid Windows handle errors
        error_msg = traceback.format_exc()
        logging.error(f"Error in train: {error_msg}")
        return {"status": False, "message": str(e)}
